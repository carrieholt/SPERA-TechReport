...
See Appendix Tables \@ref(tab:ExamPMs), \@ref(tab:CandThresh),\@ref(tab:CandExt), and \@ref(tab:CandUpp) for example performance metrics and thresholds from other case studies.
...
add_footnote(x, c("[@holt2009]", "footnote 2"), notation = "number")
```
