...
dat <- tribble(
  ...
  "Wild Salmon Policy lower benchmark*",
  ...
  "\\emph{S}gen, spawner abundances that will recover to SMSY within 1 generation in the absence of fishing under equilibrium conditions", "1"
  #"", "",  "-25th percentile of observed spawner abundances", "2"
  #"", "", "-20% of spawners at maximum recruitment (Smax)", "3,4,5"
  )
