...
- The model could include a forecast component, which would be relevant for MUs with abundance-based HCRs where forecasts or in-season assessments are required to set harvest rates or escapement goals.
...
- With the mixed-stock CU component, CU-specific harvest control rules could be included in future iterations, but these would need to be developed on a case-by-case basis including Excess Salmon to Spawning Requirements, ESSR, and Food Soccial and Ceremonital, FSC fisheries.
